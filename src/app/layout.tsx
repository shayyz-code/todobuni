    ...
    <html lang="en">
      ...
      >
        <div className="absolute top-0 left-0 w-screen h-screen">
          ...
          <div className="absolute top-[15%] -left-[2%] w-20 h-20 transform -rotate-[20deg] rounded-full bg-gradient-to-r from-slate-400 dark:from-slate-600 dark:to-slate-100 to-slate-900 shadow-2xl shadow-black"></div>
          <div className="absolute top-3/4 left-[28%] w-12 h-12 transform -rotate-[45deg] rounded-2xl bg-gradient-to-r from-slate-400 dark:from-slate-600 dark:to-slate-100 to-slate-900 shadow-2xl shadow-black"></div>
          <div className="absolute top-1/2 right-[10%] w-14 h-14 transform rotate-[28deg] rounded-full bg-gradient-to-r from-slate-400 dark:from-slate-600 dark:to-slate-100 to-slate-900 shadow-2xl shadow-black"></div>
          <div className="absolute bottom-0 right-0 w-24 h-24 transform rotate-[28deg] rounded-2xl bg-gradient-to-r from-slate-400 to-slate-900 dark:from-slate-600 dark:to-slate-100 shadow-2xl shadow-black"></div>
        </div>
        <ContextAddProvider>
          <Navbar />
          {children}
